...
package object datamodel {
  ...
  implicit val projectedGeometryDecoder: Decoder[Projected[Geometry]] = Decoder.decodeString.emap { str =>
    Either.catchNonFatal(str.parseGeoJson[Projected[Geometry]]).leftMap(t => "Projected[Geometry]")
  }
}
