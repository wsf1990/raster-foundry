...
def create_ingest_definition_op(*args, **kwargs):
    ...
    xcom_client.xcom_push(key='ingest_def_uri', value='s3://rasterfoundry-test/daunnc-test/11bf7686-d13b-402e-b72c-586a06395ca9.json')
    xcom_client.xcom_push(key='ingest_def_id', value='11bf7686-d13b-402e-b72c-586a06395ca9')
    xcom_client.xcom_push(key='scene_id', value='11bf7686-d13b-402e-b72c-586a06395ca9')
